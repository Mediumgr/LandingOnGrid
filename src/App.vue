    ...
    <section class="content center">
      ...
      <div class="content__box gs_reveal">
        ...
        <p class="content__text">
          Создайте заявку на сайте SendIt - Ваш персональный менеджер позвонит и
          подтвердит запрос, уточнит все необходимые данные
        </p>
      </div>
      <div class="content__box gs_reveal">
      ...
      <div class="leaveYourComments slider">
        ...
        <div class="first__review slides">
          <div class="firstGuest">
            ...
            <p class="comment">
              Отличный и качественный сервис. Долго искали курьерскую службу для
              доставки наших товаров. Решили попробовать и были приятно
              удивлены, что помимо удобного сайта, компания предоставляет доступ
              в личный кабинет, где реализованы многие наши потребности (ведение
              адресной базы, выбор и вызов курьера в пару кликов).
            </p>
          </div>
        </div>
        <div class="second__review hidden-slide slides">
          <div class="firstGuest">
            ...
            <p class="comment">
              ...
              фактор – всё это можно оперативно организовать и не волноваться. И
        ...
        <div class="forth__review hidden-slide slides">
          <div class="firstGuest">
            ...
            <p class="comment">
              Пользуюсь услугами данной компании почти каждый день. Давно искала
              эту компанию по доставке, проблем никаких не возникает и цены на
              доставку недорогие, отличный и качественный сервис. Все менеджеры
              приятные, товар можно отследить онлайн и доставка очень быстрая!
              Отдельное спасибо менеджеру Валентине. Рекомендую.
            </p>
          </div>
        </div>
        <!-- eslint-disable -->
          ...
          <div class="insurance">
            ...
            <div class="bottom__text">
              <p class="insurance__text">
                Контроль работы курьеров в онлайн режиме. Страхование по запросу
                клиента Каждый куръер находится под пристальным вниманием
                менеджеров SendIt
              </p>
...
import selectComponent from "./components/customSelect.vue";
